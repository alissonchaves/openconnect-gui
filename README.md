...
```bash
brew tap alissonchaves/openconnect-gui https://github.com/alissonchaves/openconnect-gui.git
brew install --cask openconnect-gui
```

If macOS blocks the app on first launch (Gatekeeper), remove the quarantine flag:
